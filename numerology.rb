...
def the_pradiction(birth_number)
case birth_number
when 1
...
when 3
	message =  "Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Three enjoy life and have a good sense of something. Ruled by Jupiter."
when 4
...
puts 'Give me your birthday in MMDDYYYY form: '
birthday = gets
birth_number = does_math(birthday)
message = the_pradiction(birth_number)
puts message
